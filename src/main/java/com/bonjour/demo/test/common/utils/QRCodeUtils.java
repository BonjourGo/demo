...
public class QRCodeUtils {
     ...
     * @return
     */
    public static String qrToBase64(String content) {
        ...
        try {
            ...
            log.error("二维码转换base64错误");
        }
        return base64;
    }

    public static void main(String[] args) {
        System.out.println(qrToBase64("hello"));
    }
    ...
    private static final String QR_CODE_IMAGE_PATH = "D:\\test.png";
